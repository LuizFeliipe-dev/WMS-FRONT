...
interface ShelfTypeFiltersSectionProps {
  search: string;
  showActive: boolean;
...
const ShelfTypeFiltersSection = ({
  search,
  showActive,
  onSearchChange,
  onToggleActive,
}: ShelfTypeFiltersSectionProps) => {
  ...
  return (
    <div className="flex flex-col md:flex-row md:items-center md:justify-between p-4 mb-6 bg-muted/40">
      ...
      <div className="flex items-center space-x-2">
        <Switch id="active" checked={showActive} onCheckedChange={onToggleActive} />
...
export default ShelfTypeFiltersSection;
